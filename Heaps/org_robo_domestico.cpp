...
void MaxHeap::corrigeDescendo(int i) {
    ...
    if((esquerda <= this->tamanho - 1) && (this->heap[esquerda].energiaGasta > this->heap[i].energiaGasta)) {
        maior = esquerda;
    }

    if((direita <= this->tamanho - 1) && (this->heap[direita].energiaGasta > this->heap[maior].energiaGasta)) {
        maior = direita;
    }
