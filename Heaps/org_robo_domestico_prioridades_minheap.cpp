...
void MaxHeap::corrigeDescendo(int i) {
    ...
    if((esquerda <= this->tamanho - 1) && (this->heap[esquerda] < this->heap[i])) {
        ...
        maior = this->heap[esquerda].tempoEstimado < this->heap[i].tempoEstimado ? esquerda : i;
    }
    ...
    if((direita <= this->tamanho - 1) && (this->heap[direita] < this->heap[maior])) {
        ...
        maior = this->heap[maior].tempoEstimado < this->heap[direita].tempoEstimado ? maior : direita;
    }
...
void MaxHeap::corrigeSubindo(int i) {
    ...
    if(this->heap[i] < this->heap[p]) {
        ...
        if(this->heap[i].tempoEstimado < this->heap[p].tempoEstimado) {
            swap(this->heap[i], this->heap[p]);
            this->corrigeSubindo(p);
        }
    }
